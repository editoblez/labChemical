...
<div class="starter-template">   
    <p class="lead"><b>Editar Materiales de la Orden de Produccion </b></p>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-md-14">     
            ...
            <?php echo form_open('produccion/actualizar_materiales_orden_produccion', $atributos) ?>

            <?php foreach ($materiales as $material) { ?>

                <input type="hidden" name="id" value="<?php echo $material->id_materiales_orden_produccion ?>">
