...
<div class="starter-template">   
    <p class="lead"><b> Reporte de Ordenes de Pedido </b></p>
</div>
...
<div class="container">
    <div class="row">
        <div class="col-md-14">     
            ...
            <?php echo form_open('reportes/mostrar_reportes_ordenes_pedido', $atributos) ?>
                    ...
                    <?php if ($var != false) { ?>
                        <?php foreach ($var as $fila) { ?>
                            <tr>          
                                ...
                                <td>
                                     <a href="<?= base_url() ?>index.php/reportes/mostrar_materiales_orden_pedido/<?php echo $fila->numero_orden ?>" class="label label-primary">Ver</a>
                                </td>
                            </tr>
                            <?php } ?>
                    <?php } ?>
